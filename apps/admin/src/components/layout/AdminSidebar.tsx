...
const adminMenu = [
  ...
  { label: "Automations & Emails", path: "/messagerie", icon: Envelope },
      ...
      >
        <div className="py-4 px-6 border-b border-gray-50 flex items-center justify-between">
          <Link
            ...
            style={{ color: "var(--admin-sidebar-text, #111827)" }}
          >
            <span className="text-primary">i</span>M-ADMIN
          </Link>
          <button
            className="lg:hidden text-gray-400 p-2 hover:text-gray-900"
            onClick={onClose}
          >
          ...
          >
            ...
            <div className="overflow-hidden">
              <p
                ...
                style={{ color: "var(--admin-card-text, #111827)" }}
              >
                Seba Aussant
              </p>
              <p
