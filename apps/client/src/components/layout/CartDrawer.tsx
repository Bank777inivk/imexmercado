      ...
      {isDrawerOpen && (
        <>
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    {t("cart:drawer.items_count", { count: totalItems })}
                  </p>
                </div>
              </div>
                ...
                <p className="text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                  ...
                  {totalPrice >= freeShippingThreshold ? (
                    <span className="text-success">
                      {t("cart:drawer.free_shipping_success")}
                    </span>
                  ) : (
                    <span
                      dangerouslySetInnerHTML={{
                        __html: t("cart:drawer.free_shipping_remaining", {
                          remaining: (
            ...
            {/* List */}
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 relative text-left">
              {items.length === 0 ? (
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                          ...
                          <div className="flex justify-between items-center mt-2">
                            <div className="flex items-center border border-gray-100 rounded-lg bg-white shadow-sm h-8 px-1">
                              ...
                              <span className="w-8 text-center font-black text-[11px] text-gray-900">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() => updateQuantity(item.id, 1)}
                    ...
                    return (
                      <div className="mt-8 pt-6 border-t border-gray-100 space-y-4 text-left">
                        <h4 className="text-[9px] font-black uppercase tracking-widest text-gray-900">
                          {t("cart:drawer.recommendations_title")}
                        </h4>
                        <div className="space-y-3">
                          {recommendedItems.map((item) => {
                            const recDisplayName = isFR
                              ? item.nameFR || item.name
                              : item.name;
                            return (
                              <div
                                key={item.id}
                                className="flex items-center justify-between gap-3 p-2 bg-gray-50/50 rounded-xl border border-gray-100"
                              >
                                <div className="flex items-center gap-3 min-w-0">
                                  ...
                                  <div className="min-w-0">
                                    <p
                                      className="text-[9px] font-black text-gray-950 truncate uppercase leading-none"
                                      title={recDisplayName}
                                    >
                                      {recDisplayName}
                                    </p>
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 space-y-4">
              ...
              <div className="grid grid-cols-1">
                ...
                >
                  <span>{t("cart:drawer.btn_checkout")}</span>
