      ...
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-100">
        <div className="flex items-center gap-4">
          <h2 className="text-lg font-extrabold text-gray-900 uppercase tracking-wide border-b-2 border-primary pb-2 pr-4 -mb-[9px] z-10 whitespace-nowrap">
            {currentLang === "pt"
              ? settings?.titlePT || t("home.flash.title", "Ofertas do Dia")
              : settings?.title || t("home.flash.title", "Offres du Jour")}
          </h2>
      ...
      <div className="relative">
        ...
        >
          {products.map((product, idx) => (
            <div
              key={product.id || idx}
              className="min-w-[160px] max-w-[160px] md:min-w-[210px] md:max-w-[210px]"
            >
              <ProductCard
                product={product}
                index={idx}
