...
const locations = [
  {
    id: "pt",
    name: "Alhos Vedros, Portugal (Siège)",
    x: "18%",
    y: "82%",
    isBase: true,
  },
      ...
      {locations.map((loc) => (
        ...
        >
          <div className="relative -translate-x-1/2 -translate-y-1/2 group/pin">
            {/* The Pin */}
            <div
              className={`p-1.5 rounded-full ${loc.isBase ? "bg-primary text-white shadow-lg shadow-primary/40" : "bg-gray-900/10 backdrop-blur-sm text-gray-900 hover:bg-white"} border border-white/50 transition-all cursor-pointer`}
            >
