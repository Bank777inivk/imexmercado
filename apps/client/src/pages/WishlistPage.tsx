        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            <h1 className="text-2xl md:text-3xl font-black text-gray-900 uppercase tracking-tighter mb-2">
              Ma Liste de <span className="text-primary">Souhaits</span>
            </h1>
        ...
        {wishlist.length > 0 ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-8">
            {wishlist.map((product: any) => (
              <div key={product.id} className="bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all group flex flex-col">
                ...
                <div className="p-4 md:p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-xs md:text-sm font-bold text-gray-900 line-clamp-2 mb-4 flex-grow">{product.name}</h3>
          ...
          <div className="bg-white p-12 md:p-24 rounded-[40px] text-center border border-gray-100 shadow-sm">
            ...
            <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight mb-4">Votre liste est vide</h2>
            <p className="text-gray-400 font-medium mb-10 max-w-md mx-auto leading-relaxed">
              Vous n'avez pas encore d'articles favoris. Parcourez notre boutique et cliquez sur le cœur pour sauvegarder vos produits préférés !
            </p>
            <Link 
              to="/boutique" 
